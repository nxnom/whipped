...
export function CompanionPRDialog({
	...
	return (
		<div className="space-y-4">
			<div>
				<h3 className="text-base font-semibold text-[#ededed]">Create Pull Request?</h3>
			...
			<div className="flex flex-col gap-2">
				<span className="text-[11px] font-medium text-[#5f6672]">Title</span>
				<Input placeholder="PR title" value={title} onChange={(e) => setTitle(e.target.value)} autoFocus />
			</div>
			<div className="flex flex-col gap-2">
				<span className="text-[11px] font-medium text-[#5f6672]">Description</span>
				<Textarea
