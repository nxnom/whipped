			...
			<div className="flex gap-2">
				...
				{isDynamic && (
					<button
						...
						className="flex items-center justify-center px-2 rounded border border-[var(--color-border-secondary)] bg-[#111111] hover:bg-[var(--color-surface-hover)] disabled:opacity-50 transition-colors"
					>
						<svg
