		...
		return (
			<div className="flex-1 flex flex-col">
				<div className="shrink-0 flex flex-col gap-1 px-10 py-6 border-b border-whip-border">
					<h1 className="text-xl font-semibold text-whip-text">Tunnel</h1>
				</div>
				...
				<div className="flex flex-col gap-6">
					...
					<div className="flex flex-col gap-4">
						<div className="flex items-center gap-3">
							<span className="text-[15px] font-semibold text-whip-text">Cloudflare Tunnel</span>
							<div className="flex-1 h-px bg-whip-panel" />
						</div>
						<div className="flex items-center justify-between">
							<div className="flex flex-col gap-0.5">
								<span className="text-[13px] font-medium text-whip-text">Auto-start tunnel</span>
								<span className="text-[11px] text-whip-faint">Start automatically when the server starts</span>
							</div>
							<button
								role="switch"
								...
								className={classNames(
									...
									config.autoStartTunnel ? "bg-whip-accent" : "bg-whip-border",
								)}
							>
								<span
									className={classNames(
