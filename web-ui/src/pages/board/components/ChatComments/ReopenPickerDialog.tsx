...
export function ReopenPickerDialog({
	...
	return (
		<div className="fixed inset-0 z-[60] flex items-center justify-center bg-black/70" onClick={onClose}>
			<div
				className="flex flex-col gap-4 bg-[#141418] rounded-xl border border-[#2a2a35] w-[420px] max-w-[90vw] p-5 shadow-[0_8px_40px_4px_rgba(0,0,0,0.38)]"
				onClick={(e) => e.stopPropagation()}
			>
				<div className="flex items-center gap-3">
					<span className="text-[14px] font-semibold text-[#f0f0f5] flex-1">Reopen — tier for the rework</span>
				...
				<div className="flex flex-col gap-1.5">
					<span className="text-[11px] font-medium text-[#60607a] tracking-[0.3px]">Tier</span>
