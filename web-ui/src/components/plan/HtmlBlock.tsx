...
// content reflow. The `plan-content` class (planContent.css, shared with
...
export function HtmlBlock({ body }: { body: string }) {
	return (
		<div
			className="plan-content overflow-x-auto text-[13px] leading-relaxed text-gray-300 break-words"
